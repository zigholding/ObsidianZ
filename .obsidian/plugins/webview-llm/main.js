...
var BaseWebViewer = class {
  ...
  html_to_markdown(html) {
    ...
    const turndown = new turndown_browser_es_exports({
      headingStyle: "atx",
      bulletListMarker: "-",
